...
for (i in stocklist){
  ...
  for (j in no.reps){
    ...
    cmsy_output$Stock <- i
    ### save raw output
    save(cmsy_output, file = paste0("Jacobian/CMSY2/CMSY2_Sensitivity_", i, "_rep", j, "_test.RData"))
  ...
  save(all_res, file = paste0("Jacobian/CMSY2/CMSY2_Sensitivity_", i, "_all_test.RData"))
