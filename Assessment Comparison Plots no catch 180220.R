...
pdf("Timeseries Plots/timeseries1.pdf", width = 8, height = 12)
...
pdf("Timeseries Plots/timeseries2.pdf", width = 8, height = 12)
...
pdf("Timeseries Plots/timeseries3.pdf", width = 8, height = 12)
...
pdf("Timeseries Plots/timeseries_important.pdf", width =  6.69291, height = 12)
